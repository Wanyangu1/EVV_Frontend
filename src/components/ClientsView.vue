...
<template>
  <div class="min-h-screen bg-gray-50 py-4 px-0 md:px-4 lg:px-6">
    <div class="max-w-5xl mx-auto">
      <!-- Page Header -->
      <div class=" mb-8">
        <h1 class="text-2xl md:text-2xl font-bold text-gray-900 mb-2">EVV Clients Management</h1>
      ...
      <div class="bg-white shadow rounded-lg overflow-hidden">
        <div class="p-4">
          ...
          <div class="mb-8 pb-6 border-b border-gray-200">
            ...
            <!-- Client Form -->
            <div v-if="showCustomForm" class="mt-6 p-2 md:p-6 border border-gray-200 rounded-lg bg-gray-50">
